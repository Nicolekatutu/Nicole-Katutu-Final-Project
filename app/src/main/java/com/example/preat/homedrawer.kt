...
import com.example.preat.Model.Category
...
import kotlinx.android.synthetic.main.activity_homedrawer.*
import kotlinx.android.synthetic.main.app_bar_homedrawer.*
import kotlinx.android.synthetic.main.content_homedrawer.*
import kotlinx.android.synthetic.main.nav_header_homedrawer.view.*

class homedrawer: AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
        ...
        viewHolder = object : FirebaseRecyclerAdapter<Category, MenuViewHolder>(categoryOption) {
            ...
            override fun onBindViewHolder(holder: MenuViewHolder, position: Int, model: Category) {
                ...
                Picasso.get()
                    ...
                    .error(R.drawable.ribs)
                    .into(holder.categoryImg)

                val itemClickListener = object : ItemClickListener {
                    override fun onClick(view: View, position: Int, isLongClick: Boolean) {
                        val intent = Intent(this@homedrawer, ProductListActivity::class.java)
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        menuInflater.inflate(R.menu.homedrawer, menu)
        return true
    }
